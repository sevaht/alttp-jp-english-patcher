...
| Generate the whole program | base `bank_00/02/0C/0D/0E/13/18/1C/1D.asm` hooked in place; graft `bank_20/22/23/26/27/2C/2D/2E.asm` beside them; `main.asm` wired (`bank_2X` includes + 2 MB padding); every untouched unit round-tripped |
